...
// topbar 높이를 CSS 변수로 자동 반영 (FHD/모바일 모두 안정)
...
const PROJECTS = {
  ...
  p2: {
    ...
    summary:
      "외부 채널 기반 인재 정보를 내부 인텔리전스 플랫폼 DB로 전환.<br/>기준 수립·정제·검증으로 운영 신뢰도 확보.",
    meta: {
      company: "Smilegate Holdings |<br/>Talent Relations Team",
  ...
  p3: {
    ...
    summary:
      "침입식물 ‘환삼덩굴’ 문제를 자원 전환으로 재정의.<br/>제작비 확보 → OEM/연구원 협업 → 시제품 검증 → 팝업 테스트 → 개선까지 실행.",
    meta: {
      company: "Pill Good",
...
// ==============================
// 6) Scroll Reveal (root = snap)
// ==============================
(() => {
const targets = document.querySelectorAll(
".hero .container, .section .container, .footer .container, .section__head, .about__card, .skillCard, .projectCard, .visionDiagram, .visionStatement"
);
